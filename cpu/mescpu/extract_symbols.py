...
EXTRA_SYMBOLS = ["__aeabi_dadd",
                 ...
                 "gpu_update_palette",
                 "sdcard_init",
                 "sdcard_calculate_crc7",
                 "sdcard_calculate_crc16",
                 "sdcard_request_csd",
                 "sdcard_calculate_size_csdv2",
                 "sdcard_calculate_size_csdv1",
                 "sdcard_calculate_size",
                 "sdcard_set_spi_baudrate",
                 "sdcard_establish_spi",
                 "sdcard_set_spi_baudrate",
                 "sdcard_args_send_if_cond",
                 "sdcard_select",
                 "sdcard_release",
                 "sdcard_transceive",
                 "sdcard_read",
