...
EXTRA_SYMBOLS = ["__aeabi_dadd", "__aeabi_ddiv", "__aeabi_dmul",
                 ...
                 "__aeabi_f2d", "__aeabi_ui2d", "__aeabi_i2d",
                 "__aeabi_l2d", "__aeabi_ul2d", "__aeabi_i2f",
                 "__aeabi_ui2f", "__aeabi_l2f", "__aeabi_ul2f",
                 "__aeabi_lmul", "__aeabi_ldivmod",
                 "__aeabi_uldivmod", "__aeabi_llsl", "__aeabi_llsr",
                 "__aeabi_lcmp", "__aeabi_ulcmp", "__aeabi_idiv",
                 "__aeabi_uidiv", "__aeabi_idivmod",
                 "__aeabi_uidivmod", "__aeabi_idiv0", "__aeabi_ldiv0",
                 "__aeabi_uread4", "__aeabi_uwrite4",
                 "__aeabi_uread8", "__aeabi_uwrite8",
                 "__aeabi_memcpy8", "__aeabi_memcpy4",
                 "__aeabi_memcpy", "__aeabi_memmove8",
                 "__aeabi_memmove4", "__aeabi_memmove",
                 "__aeabi_memset8", "__aeabi_memset4",
                 "__aeabi_memset", "__aeabi_memclr8",
                 "__aeabi_memclr4", "__aeabi_memclr",
                 "gpu_print_text", "gpu_reset", "gpu_blank",
                 "gpu_swap_buf", "gpu_send_buf", "gpu_display_buf",
                 "gpu_block_frame", "gpu_block_frames",
                 "gpu_block_ack", "gpu_show_startup",
                 "gpu_adjust_brightness", "gpu_draw_sdcard",
                 "gpu_update_palette", "sdcard_init",
                 "sdcard_calculate_crc7", "sdcard_calculate_crc16",
                 "sdcard_request_csd", "sdcard_calculate_size_csdv2",
                 ...
                 "input_change_freq", "realloc", "puts", "round"]
